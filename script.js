...
const tr={
en:{navWork:"Work",navServices:"Services",navAbout:"About",navContact:"Contact",heroLabel:"CREATIVE FREELANCE",heroText:"Art, design, video, and more",seeWork:"SEE MY WORK",contactLink:"Get in touch ↗",workLabel:"WORK",workTitle:"Selected work",servicesLabel:"SERVICES",servicesTitle:"Things I can build",aboutLabel:"ABOUT",aboutTitle:"More than one discipline.",aboutText:"I'm Muhamad , a freelancer working across illustration, graphic design, video editing and game creation. I can turn ideas into finished work.",statFields:"Creative fields",statIdeas:"Creative ideas",contactLabel:"CONTACT",ctaTitle:"Have a project<br><i>in mind?</i>",ctaText:"Tell me what you're building and let's turn the idea into something real.",footer:"Freelance creative · Egypt"},
ar:{navWork:"الأعمال",navServices:"الخدمات",navAbout:"عني",navContact:"تواصل",heroLabel:"مستقل مبدع",heroText:"رسم وتصميم ومونتاج وأكثر.",seeWork:"أعمالي",contactLink:"تواصل معي ↗",workLabel:"الأعمال",workTitle:"أعمال مميزة",servicesLabel:"الخدمات",servicesTitle:"أشياء أستطيع تنفيذها",aboutLabel:"عني",aboutTitle:"أكثر من مجرد مجال واحد.",aboutText:"أنا محمد، مستقل أعمل في الرسم والتصميم الجرافيكي والمونتاج وتطوير الألعاب. يمكنني تحويل الأفكار إلى أعمال مكتملة.",statFields:"مجالات إبداعية",statIdeas:"أفكار بداعية",contactLabel:"تواصل",ctaTitle:"عندك مشروع<br><i>في بالك؟</i>",ctaText:"احكي لي عن المشروع، ونحوّل الفكرة إلى شيء حقيقي.",footer:"مستقل ومبدع · مصر"}
};
